...
import { buildTesterSecondTesterAccountWritePilotReport } from "@/lib/ops/testerSecondTesterAccountWritePilot";

export default function TesterSecondTesterAccountWritePilotPanel() {
  const report = useMemo(() => buildTesterSecondTesterAccountWritePilotReport(), []);
  ...
  return (
    <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
        Pilot protetto per creare un solo secondo tester. Dry-run di default, nessuna password e nessun invito email.
      </p>
