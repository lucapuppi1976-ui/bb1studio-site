...
export default function OperationsTesterManualUatScenarioPack() {
  const report = buildTesterManualUatScenarioPackReport();
  ...
  return (
    <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
        Checklist scenari ed evidenze per il primo test manuale del tester pilota.
      </p>
