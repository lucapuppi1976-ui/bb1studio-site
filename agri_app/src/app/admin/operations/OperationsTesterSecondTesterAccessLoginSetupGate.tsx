...
export default function OperationsTesterSecondTesterAccessLoginSetupGate() {
  const report = buildTesterSecondTesterAccessLoginSetupReport();
  ...
  return (
    <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <h2 className="mt-2 text-xl font-bold text-slate-950">
        Second Tester Access & Login Setup Gate
      </h2>
      <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
        Verifica secondo tester: account, ruolo, metodo login, osservazione manuale e prossima release.
      </p>
