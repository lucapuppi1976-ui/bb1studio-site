...
const files = {
  engine: "src/lib/ai/aiProviderSafeEnablementGate.ts",
  route: "src/app/api/ops/ai-provider-safe-enablement-gate-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/ProviderSafeEnablementGatePanel.tsx",
  admin: "src/app/admin/operations/OperationsAiProviderSafeEnablementGate.tsx",
  readme: "AI_PROVIDER_SAFE_ENABLEMENT_GATE_V12_7.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiProviderSafeEnablementGateReport");
requireText("engine", engine, "aiProviderSafeEnablementGateVersion");
requireText("engine", engine, "ProviderSafeEnablementGateReport");
requireText("engine", engine, "SafeEnablementSourceNode");
requireText("engine", engine, "SafeEnablementGateItem");
requireText("engine", engine, "DualControlApprovalItem");
requireText("engine", engine, "ChangeTicketDraftItem");
requireText("engine", engine, "safeEnablementGateReady: true");
requireText("engine", engine, "dualControlReviewReady: true");
requireText("engine", engine, "changeTicketDraftReady: true");
requireText("engine", engine, "providerNonCallProofReady: true");
...
requireText("route", route, "/api/ops/ai-provider-safe-enablement-gate-dry-run");

requireText("ui", ui, "ProviderSafeEnablementGatePanel");
requireText("ui", ui, "Provider Safe Enablement Gate & Dual-Control Activation Simulator");

requireText("admin", admin, "OperationsAiProviderSafeEnablementGate");
requireText("admin", admin, "/api/ops/ai-provider-safe-enablement-gate-dry-run");

requireText("readme", readme, "AI Provider Safe Enablement Gate & Dual-Control Activation Simulator");
requireText("package", pkg, "ops:ai-provider-safe-enablement-gate-check");
requireText("runbook", runbook, "V12.7");
requireText("runbook", runbook, "ops:ai-provider-safe-enablement-gate-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V12_7_PROVIDER_SAFE_ENABLEMENT_GATE_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-provider-safe-enablement-gate-check",
  version: "V12.7",
