...
const files = {
  engine: "src/lib/ai/aiFieldAutopilotControlRoom.ts",
  route: "src/app/api/ops/ai-field-autopilot-control-room-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/FieldAutopilotControlRoomPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiFieldAutopilotControlRoom.tsx",
  readme: "AI_FIELD_AUTOPILOT_CONTROL_ROOM_V10_1.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiFieldAutopilotControlRoomReport");
requireText("engine", engine, "aiFieldAutopilotControlRoomVersion");
requireText("engine", engine, "FieldAutopilotControlRoomReport");
requireText("engine", engine, "AutopilotModuleState");
requireText("engine", engine, "SimulationLane");
requireText("engine", engine, "AutopilotCommandCandidate");
requireText("engine", engine, "ManualReviewBoardItem");
requireText("engine", engine, "autopilotSimulationReady: true");
requireText("engine", engine, "multiModuleCoordinationReady: true");
requireText("engine", engine, "dispatchPreviewReady: true");
requireText("engine", engine, "emergencyStopReady: true");
...
requireText("route", route, "/api/ops/ai-field-autopilot-control-room-dry-run");

requireText("ui", ui, "FieldAutopilotControlRoomPanel");
requireText("ui", ui, "Field Autopilot Simulation Control Room");

requireText("admin", admin, "OperationsAiFieldAutopilotControlRoom");
requireText("admin", admin, "/api/ops/ai-field-autopilot-control-room-dry-run");

requireText("readme", readme, "AI Field Autopilot Simulation Control Room");
requireText("package", pkg, "ops:ai-field-autopilot-control-room-check");
requireText("runbook", runbook, "V10.1");
requireText("runbook", runbook, "ops:ai-field-autopilot-control-room-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V10_1_FIELD_AUTOPILOT_CONTROL_ROOM_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-field-autopilot-control-room-check",
  version: "V10.1",
