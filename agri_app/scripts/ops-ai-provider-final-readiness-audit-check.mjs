...
const files = {
  engine: "src/lib/ai/aiProviderFinalReadinessAudit.ts",
  route: "src/app/api/ops/ai-provider-final-readiness-audit-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/ProviderFinalReadinessAuditPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiProviderFinalReadinessAudit.tsx",
  readme: "AI_PROVIDER_FINAL_READINESS_AUDIT_V12_9.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiProviderFinalReadinessAuditReport");
requireText("engine", engine, "aiProviderFinalReadinessAuditVersion");
requireText("engine", engine, "ProviderFinalReadinessAuditReport");
requireText("engine", engine, "FinalAuditSourceNode");
requireText("engine", engine, "FinalAuditDossierItem");
requireText("engine", engine, "ActivationFreezeLedgerItem");
requireText("engine", engine, "ReleaseFreezeGateItem");
requireText("engine", engine, "finalReadinessAuditReady: true");
requireText("engine", engine, "activationFreezeLedgerReady: true");
requireText("engine", engine, "executiveAuditPackReady: true");
...
requireText("route", route, "/api/ops/ai-provider-final-readiness-audit-dry-run");

requireText("ui", ui, "ProviderFinalReadinessAuditPanel");
requireText("ui", ui, "Provider Final Readiness Audit Pack & Activation Freeze Ledger");

requireText("admin", admin, "OperationsAiProviderFinalReadinessAudit");
requireText("admin", admin, "/api/ops/ai-provider-final-readiness-audit-dry-run");

requireText("readme", readme, "AI Provider Final Readiness Audit Pack & Activation Freeze Ledger");
requireText("package", pkg, "ops:ai-provider-final-readiness-audit-check");
requireText("runbook", runbook, "V12.9");
requireText("runbook", runbook, "ops:ai-provider-final-readiness-audit-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V12_9_PROVIDER_FINAL_READINESS_AUDIT_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-provider-final-readiness-audit-check",
  version: "V12.9",
