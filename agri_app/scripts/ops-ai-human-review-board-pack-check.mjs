...
const files = {
  engine: "src/lib/ai/aiHumanReviewBoardPack.ts",
  route: "src/app/api/ops/ai-human-review-board-pack-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/HumanReviewBoardPackPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiHumanReviewBoardPack.tsx",
  readme: "AI_HUMAN_REVIEW_BOARD_PACK_V13_4.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiHumanReviewBoardPackReport");
requireText("engine", engine, "aiHumanReviewBoardPackVersion");
requireText("engine", engine, "HumanReviewBoardPackReport");
requireText("engine", engine, "BoardBriefingItem");
requireText("engine", engine, "DecisionFreezeCertificateItem");
requireText("engine", engine, "ReviewOutcomeMatrixItem");
requireText("engine", engine, "humanBoardPackReady: true");
requireText("engine", engine, "decisionFreezeCertificateReady: true");
requireText("engine", engine, "nonActionableExportReady: true");
requireText("engine", engine, "humanBoardSignoffReady: true");
...
requireText("route", route, "/api/ops/ai-human-review-board-pack-dry-run");

requireText("ui", ui, "HumanReviewBoardPackPanel");
requireText("ui", ui, "Human Review Board Pack & Decision Freeze Certificate");

requireText("admin", admin, "OperationsAiHumanReviewBoardPack");
requireText("admin", admin, "/api/ops/ai-human-review-board-pack-dry-run");

requireText("readme", readme, "AI Human Review Board Pack & Decision Freeze Certificate");
requireText("package", pkg, "ops:ai-human-review-board-pack-check");
requireText("runbook", runbook, "V13.4");
requireText("runbook", runbook, "ops:ai-human-review-board-pack-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V13_4_HUMAN_REVIEW_BOARD_PACK_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-human-review-board-pack-check",
  version: "V13.4",
