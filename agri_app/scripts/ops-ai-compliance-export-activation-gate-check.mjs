...
const files = {
  engine: "src/lib/ai/aiComplianceExportActivationGate.ts",
  route: "src/app/api/ops/ai-compliance-export-activation-gate-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/ComplianceExportActivationGatePanel.tsx",
  admin: "src/app/admin/operations/OperationsAiComplianceExportActivationGate.tsx",
  readme: "AI_COMPLIANCE_EXPORT_ACTIVATION_GATE_V16_6.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiComplianceExportActivationGateReport");
requireText("engine", engine, "aiComplianceExportActivationGateVersion");
requireText("engine", engine, "ComplianceExportActivationReport");
requireText("engine", engine, "ExportActivationGateItem");
requireText("engine", engine, "PrivacyRedactionApprovalItem");
requireText("engine", engine, "ExportPublicationNoGoItem");
requireText("engine", engine, "complianceExportActivationGateReady: true");
requireText("engine", engine, "privacyRedactionApprovalReady: true");
requireText("engine", engine, "legalReviewLockReady: true");
requireText("engine", engine, "exportNoGoReady: true");
requireText("engine", engine, "complianceExportActivationAllowed: false");
requireText("engine", engine, "exportFileWriteAllowed: false");
requireText("engine", engine, "exportPublicationAllowed: false");
...
requireText("route", route, "/api/ops/ai-compliance-export-activation-gate-dry-run");

requireText("ui", ui, "ComplianceExportActivationGatePanel");
requireText("ui", ui, "Compliance Export Activation Gate & Privacy Redaction Approval Lock");

requireText("admin", admin, "OperationsAiComplianceExportActivationGate");
requireText("admin", admin, "/api/ops/ai-compliance-export-activation-gate-dry-run");

requireText("readme", readme, "AI Compliance Export Activation Gate & Privacy Redaction Approval Lock");
requireText("package", pkg, "ops:ai-compliance-export-activation-gate-check");
requireText("runbook", runbook, "V16.6");
requireText("runbook", runbook, "ops:ai-compliance-export-activation-gate-check");
...
const falseFlags = [
  ...
  "privacyRedactionApprovalAllowed",
  "privacyRedactionApprovalPerformed",
  "legalReviewApprovalAllowed",
  "legalReviewApprovalPerformed",
  "exportPublicationAllowed",
  "exportPublicationPerformed",
  "exportFileWriteAllowed",
  "exportFileWritePerformed",
];
...
const trueFlags = [
  ...
  "zeroActivationMode",
  "complianceExportActivationGateReady",
  "privacyRedactionApprovalReady",
  "legalReviewLockReady",
  "exportNoGoReady",
];
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V16_6_COMPLIANCE_EXPORT_ACTIVATION_GATE_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-compliance-export-activation-gate-check",
  version: "V16.6",
