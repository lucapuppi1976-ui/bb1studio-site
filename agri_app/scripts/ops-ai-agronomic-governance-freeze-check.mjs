...
const files = {
  engine: "src/lib/ai/aiAgronomicGovernanceFreeze.ts",
  route: "src/app/api/ops/ai-agronomic-governance-freeze-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/AgronomicGovernanceFreezePanel.tsx",
  admin: "src/app/admin/operations/OperationsAiAgronomicGovernanceFreeze.tsx",
  readme: "AI_AGRONOMIC_GOVERNANCE_FREEZE_V14_4.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiAgronomicGovernanceFreezeReport");
requireText("engine", engine, "aiAgronomicGovernanceFreezeVersion");
requireText("engine", engine, "AgronomicGovernanceFreezeReport");
requireText("engine", engine, "GovernanceFreezeItem");
requireText("engine", engine, "SignoffRegistryItem");
requireText("engine", engine, "ActionabilityTrapItem");
requireText("engine", engine, "governanceFreezeReady: true");
requireText("engine", engine, "signoffRegistryReady: true");
requireText("engine", engine, "actionabilityTrapBoardReady: true");
requireText("engine", engine, "humanGovernanceSignoffReady: true");
...
requireText("route", route, "/api/ops/ai-agronomic-governance-freeze-dry-run");

requireText("ui", ui, "AgronomicGovernanceFreezePanel");
requireText("ui", ui, "Agronomic Governance Freeze & Strategy Signoff Registry");

requireText("admin", admin, "OperationsAiAgronomicGovernanceFreeze");
requireText("admin", admin, "/api/ops/ai-agronomic-governance-freeze-dry-run");

requireText("readme", readme, "AI Agronomic Governance Freeze & Strategy Signoff Registry");
requireText("package", pkg, "ops:ai-agronomic-governance-freeze-check");
requireText("runbook", runbook, "V14.4");
requireText("runbook", runbook, "ops:ai-agronomic-governance-freeze-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V14_4_AGRONOMIC_GOVERNANCE_FREEZE_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-agronomic-governance-freeze-check",
  version: "V14.4",
