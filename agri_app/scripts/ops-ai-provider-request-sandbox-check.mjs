...
const files = {
  engine: "src/lib/ai/aiProviderRequestSandbox.ts",
  route: "src/app/api/ops/ai-provider-request-sandbox-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/ProviderRequestSandboxPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiProviderRequestSandbox.tsx",
  readme: "AI_PROVIDER_REQUEST_SANDBOX_V12_1.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiProviderRequestSandboxReport");
requireText("engine", engine, "aiProviderRequestSandboxVersion");
requireText("engine", engine, "ProviderRequestSandboxReport");
requireText("engine", engine, "ProviderRequestSourceNode");
requireText("engine", engine, "RequestBlueprintSection");
requireText("engine", engine, "RedactionContractRule");
requireText("engine", engine, "OutputContractItem");
requireText("engine", engine, "providerRequestSandboxReady: true");
requireText("engine", engine, "redactionContractReviewReady: true");
requireText("engine", engine, "outputSchemaReviewReady: true");
...
requireText("route", route, "/api/ops/ai-provider-request-sandbox-dry-run");

requireText("ui", ui, "ProviderRequestSandboxPanel");
requireText("ui", ui, "Provider Request Sandbox & Redaction Contract Kernel");

requireText("admin", admin, "OperationsAiProviderRequestSandbox");
requireText("admin", admin, "/api/ops/ai-provider-request-sandbox-dry-run");

requireText("readme", readme, "AI Provider Request Sandbox & Redaction Contract Kernel");
requireText("package", pkg, "ops:ai-provider-request-sandbox-check");
requireText("runbook", runbook, "V12.1");
requireText("runbook", runbook, "ops:ai-provider-request-sandbox-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V12_1_PROVIDER_REQUEST_SANDBOX_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-provider-request-sandbox-check",
  version: "V12.1",
