...
const files = {
  engine: "src/lib/ai/aiProviderActivationFirewall.ts",
  route: "src/app/api/ops/ai-provider-activation-firewall-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/ProviderActivationFirewallPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiProviderActivationFirewall.tsx",
  readme: "AI_PROVIDER_ACTIVATION_FIREWALL_V12_0.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiProviderActivationFirewallReport");
requireText("engine", engine, "aiProviderActivationFirewallVersion");
requireText("engine", engine, "ProviderActivationFirewallReport");
requireText("engine", engine, "ProviderFirewallSourceNode");
requireText("engine", engine, "ProviderReadinessGate");
requireText("engine", engine, "PayloadReviewItem");
requireText("engine", engine, "RuntimeFirewallRule");
requireText("engine", engine, "providerActivationFirewallReady: true");
requireText("engine", engine, "runtimeSafetyControlPlaneReady: true");
requireText("engine", engine, "payloadMinimizationReviewReady: true");
requireText("engine", engine, "manualApprovalBoardReady: true");
...
requireText("route", route, "/api/ops/ai-provider-activation-firewall-dry-run");

requireText("ui", ui, "ProviderActivationFirewallPanel");
requireText("ui", ui, "Provider Activation Firewall & Runtime Safety Control Plane");

requireText("admin", admin, "OperationsAiProviderActivationFirewall");
requireText("admin", admin, "/api/ops/ai-provider-activation-firewall-dry-run");

requireText("readme", readme, "AI Provider Activation Firewall & Runtime Safety Control Plane");
requireText("package", pkg, "ops:ai-provider-activation-firewall-check");
requireText("runbook", runbook, "V12.0");
requireText("runbook", runbook, "ops:ai-provider-activation-firewall-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V12_0_PROVIDER_ACTIVATION_FIREWALL_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-provider-activation-firewall-check",
  version: "V12.0",
