...
const files = {
  engine: "src/lib/ai/aiClimateWaterStrategy.ts",
  route: "src/app/api/ops/ai-climate-water-strategy-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/ClimateWaterStrategyPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiClimateWaterStrategy.tsx",
  readme: "AI_CLIMATE_WATER_STRATEGY_V10_5.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiClimateWaterStrategyReport");
requireText("engine", engine, "aiClimateWaterStrategyVersion");
requireText("engine", engine, "ClimateWaterStrategyReport");
requireText("engine", engine, "ClimateRiskZone");
requireText("engine", engine, "WaterStrategyScenario");
requireText("engine", engine, "ClimateGovernanceStop");
requireText("engine", engine, "ClimateManualReviewItem");
requireText("engine", engine, "climateResilienceSimulationReady: true");
requireText("engine", engine, "waterStrategySandboxReady: true");
requireText("engine", engine, "heatStressReviewReady: true");
requireText("engine", engine, "irrigationReadinessReviewReady: true");
...
requireText("route", route, "/api/ops/ai-climate-water-strategy-dry-run");

requireText("ui", ui, "ClimateWaterStrategyPanel");
requireText("ui", ui, "Climate Resilience & Water Strategy Simulator");

requireText("admin", admin, "OperationsAiClimateWaterStrategy");
requireText("admin", admin, "/api/ops/ai-climate-water-strategy-dry-run");

requireText("readme", readme, "AI Climate Resilience & Water Strategy Simulator");
requireText("package", pkg, "ops:ai-climate-water-strategy-check");
requireText("runbook", runbook, "V10.5");
requireText("runbook", runbook, "ops:ai-climate-water-strategy-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V10_5_CLIMATE_WATER_STRATEGY_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-climate-water-strategy-check",
  version: "V10.5",
