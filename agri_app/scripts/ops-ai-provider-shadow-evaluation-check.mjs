...
const files = {
  engine: "src/lib/ai/aiProviderShadowEvaluation.ts",
  route: "src/app/api/ops/ai-provider-shadow-evaluation-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/ProviderShadowEvaluationPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiProviderShadowEvaluation.tsx",
  readme: "AI_PROVIDER_SHADOW_EVALUATION_V12_3.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiProviderShadowEvaluationReport");
requireText("engine", engine, "aiProviderShadowEvaluationVersion");
requireText("engine", engine, "ProviderShadowEvaluationReport");
requireText("engine", engine, "ProviderShadowSourceNode");
requireText("engine", engine, "SyntheticBenchmarkCase");
requireText("engine", engine, "ShadowEvaluationMetric");
requireText("engine", engine, "RejectionDrillItem");
requireText("engine", engine, "providerShadowEvaluationReady: true");
requireText("engine", engine, "syntheticBenchmarkHarnessReady: true");
requireText("engine", engine, "rejectionDrillReady: true");
...
requireText("route", route, "/api/ops/ai-provider-shadow-evaluation-dry-run");

requireText("ui", ui, "ProviderShadowEvaluationPanel");
requireText("ui", ui, "Provider Shadow Evaluation & Synthetic Benchmark Harness");

requireText("admin", admin, "OperationsAiProviderShadowEvaluation");
requireText("admin", admin, "/api/ops/ai-provider-shadow-evaluation-dry-run");

requireText("readme", readme, "AI Provider Shadow Evaluation & Synthetic Benchmark Harness");
requireText("package", pkg, "ops:ai-provider-shadow-evaluation-check");
requireText("runbook", runbook, "V12.3");
requireText("runbook", runbook, "ops:ai-provider-shadow-evaluation-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V12_3_PROVIDER_SHADOW_EVALUATION_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-provider-shadow-evaluation-check",
  version: "V12.3",
