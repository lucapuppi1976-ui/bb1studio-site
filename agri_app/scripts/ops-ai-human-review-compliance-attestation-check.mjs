...
const files = {
  engine: "src/lib/ai/aiHumanReviewComplianceAttestation.ts",
  route: "src/app/api/ops/ai-human-review-compliance-attestation-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/HumanReviewComplianceAttestationPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiHumanReviewComplianceAttestation.tsx",
  readme: "AI_HUMAN_REVIEW_COMPLIANCE_ATTESTATION_V13_6.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiHumanReviewComplianceAttestationReport");
requireText("engine", engine, "aiHumanReviewComplianceAttestationVersion");
requireText("engine", engine, "HumanReviewComplianceAttestationReport");
requireText("engine", engine, "ComplianceAttestationItem");
requireText("engine", engine, "AccountabilityLedgerItem");
requireText("engine", engine, "GovernanceEvidencePackItem");
requireText("engine", engine, "humanComplianceAttestationReady: true");
requireText("engine", engine, "accountabilityLedgerReady: true");
requireText("engine", engine, "governanceEvidencePackReady: true");
requireText("engine", engine, "humanComplianceSignoffReady: true");
...
requireText("route", route, "/api/ops/ai-human-review-compliance-attestation-dry-run");

requireText("ui", ui, "HumanReviewComplianceAttestationPanel");
requireText("ui", ui, "Human Review Compliance Attestation & Accountability Ledger");

requireText("admin", admin, "OperationsAiHumanReviewComplianceAttestation");
requireText("admin", admin, "/api/ops/ai-human-review-compliance-attestation-dry-run");

requireText("readme", readme, "AI Human Review Compliance Attestation & Accountability Ledger");
requireText("package", pkg, "ops:ai-human-review-compliance-attestation-check");
requireText("runbook", runbook, "V13.6");
requireText("runbook", runbook, "ops:ai-human-review-compliance-attestation-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V13_6_HUMAN_REVIEW_COMPLIANCE_ATTESTATION_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-human-review-compliance-attestation-check",
  version: "V13.6",
