...
const files = {
  engine: "src/lib/ai/aiHumanReviewMissionControl.ts",
  route: "src/app/api/ops/ai-human-review-mission-control-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/HumanReviewMissionControlPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiHumanReviewMissionControl.tsx",
  readme: "AI_HUMAN_REVIEW_MISSION_CONTROL_V13_0.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiHumanReviewMissionControlReport");
requireText("engine", engine, "aiHumanReviewMissionControlVersion");
requireText("engine", engine, "HumanReviewMissionControlReport");
requireText("engine", engine, "ReviewQueueItem");
requireText("engine", engine, "EvidenceArbitrationItem");
requireText("engine", engine, "ReviewerDisagreementItem");
requireText("engine", engine, "humanMissionControlReady: true");
requireText("engine", engine, "evidenceArbitrationReady: true");
requireText("engine", engine, "reviewerDisagreementReady: true");
requireText("engine", engine, "humanSignoffPacketReady: true");
...
requireText("route", route, "/api/ops/ai-human-review-mission-control-dry-run");

requireText("ui", ui, "HumanReviewMissionControlPanel");
requireText("ui", ui, "Human Reviewer Mission Control & Evidence Arbitration Board");

requireText("admin", admin, "OperationsAiHumanReviewMissionControl");
requireText("admin", admin, "/api/ops/ai-human-review-mission-control-dry-run");

requireText("readme", readme, "AI Human Reviewer Mission Control & Evidence Arbitration Board");
requireText("package", pkg, "ops:ai-human-review-mission-control-check");
requireText("runbook", runbook, "V13.0");
requireText("runbook", runbook, "ops:ai-human-review-mission-control-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V13_0_HUMAN_REVIEW_MISSION_CONTROL_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-human-review-mission-control-check",
  version: "V13.0",
