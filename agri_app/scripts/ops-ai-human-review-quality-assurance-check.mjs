...
const files = {
  engine: "src/lib/ai/aiHumanReviewQualityAssurance.ts",
  route: "src/app/api/ops/ai-human-review-quality-assurance-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/HumanReviewQualityAssurancePanel.tsx",
  admin: "src/app/admin/operations/OperationsAiHumanReviewQualityAssurance.tsx",
  readme: "AI_HUMAN_REVIEW_QUALITY_ASSURANCE_V13_5.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiHumanReviewQualityAssuranceReport");
requireText("engine", engine, "aiHumanReviewQualityAssuranceVersion");
requireText("engine", engine, "HumanReviewQualityAssuranceReport");
requireText("engine", engine, "PeerCalibrationItem");
requireText("engine", engine, "RubricQualityItem");
requireText("engine", engine, "ReviewerDriftWatchItem");
requireText("engine", engine, "humanReviewQaReady: true");
requireText("engine", engine, "peerCalibrationReady: true");
requireText("engine", engine, "reviewerDriftWatchReady: true");
requireText("engine", engine, "humanQaSignoffReady: true");
...
requireText("route", route, "/api/ops/ai-human-review-quality-assurance-dry-run");

requireText("ui", ui, "HumanReviewQualityAssurancePanel");
requireText("ui", ui, "Human Review Quality Assurance & Peer Calibration Audit");

requireText("admin", admin, "OperationsAiHumanReviewQualityAssurance");
requireText("admin", admin, "/api/ops/ai-human-review-quality-assurance-dry-run");

requireText("readme", readme, "AI Human Review Quality Assurance & Peer Calibration Audit");
requireText("package", pkg, "ops:ai-human-review-quality-assurance-check");
requireText("runbook", runbook, "V13.5");
requireText("runbook", runbook, "ops:ai-human-review-quality-assurance-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V13_5_HUMAN_REVIEW_QUALITY_ASSURANCE_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-human-review-quality-assurance-check",
  version: "V13.5",
