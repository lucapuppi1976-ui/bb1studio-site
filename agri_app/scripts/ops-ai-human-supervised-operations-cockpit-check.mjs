...
const files = {
  engine: "src/lib/ai/aiHumanSupervisedOperationsCockpit.ts",
  route: "src/app/api/ops/ai-human-supervised-operations-cockpit-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/HumanSupervisedOperationsCockpitPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiHumanSupervisedOperationsCockpit.tsx",
  readme: "AI_HUMAN_SUPERVISED_OPERATIONS_COCKPIT_V16_3.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiHumanSupervisedOperationsCockpitReport");
requireText("engine", engine, "aiHumanSupervisedOperationsCockpitVersion");
requireText("engine", engine, "HumanSupervisedOperationsCockpitReport");
requireText("engine", engine, "OperatorBoardItem");
requireText("engine", engine, "ManualDispatchReadinessItem");
requireText("engine", engine, "ExecutionNoGoItem");
requireText("engine", engine, "humanSupervisedCockpitReady: true");
requireText("engine", engine, "manualDispatchReadinessReady: true");
requireText("engine", engine, "escalationPathReady: true");
...
requireText("route", route, "/api/ops/ai-human-supervised-operations-cockpit-dry-run");

requireText("ui", ui, "HumanSupervisedOperationsCockpitPanel");
requireText("ui", ui, "Human-Supervised Agronomic Operations Cockpit & Manual Dispatch Readiness");

requireText("admin", admin, "OperationsAiHumanSupervisedOperationsCockpit");
requireText("admin", admin, "/api/ops/ai-human-supervised-operations-cockpit-dry-run");

requireText("readme", readme, "AI Human-Supervised Agronomic Operations Cockpit & Manual Dispatch Readiness");
requireText("package", pkg, "ops:ai-human-supervised-operations-cockpit-check");
requireText("runbook", runbook, "V16.3");
requireText("runbook", runbook, "ops:ai-human-supervised-operations-cockpit-check");
...
const trueFlags = [
  ...
  "zeroActivationMode",
  "humanSupervisedCockpitReady",
  "manualDispatchReadinessReady",
  "escalationPathReady",
  "executionNoGoReady",
];
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V16_3_HUMAN_SUPERVISED_OPERATIONS_COCKPIT_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-human-supervised-operations-cockpit-check",
  version: "V16.3",
