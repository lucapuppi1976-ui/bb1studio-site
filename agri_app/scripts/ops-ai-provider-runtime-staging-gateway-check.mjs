...
const files = {
  engine: "src/lib/ai/aiProviderRuntimeStagingGateway.ts",
  route: "src/app/api/ops/ai-provider-runtime-staging-gateway-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/ProviderRuntimeStagingGatewayPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiProviderRuntimeStagingGateway.tsx",
  readme: "AI_PROVIDER_RUNTIME_STAGING_GATEWAY_V15_1.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiProviderRuntimeStagingGatewayReport");
requireText("engine", engine, "aiProviderRuntimeStagingGatewayVersion");
requireText("engine", engine, "ProviderRuntimeStagingReport");
requireText("engine", engine, "GatewayDesignItem");
requireText("engine", engine, "RequestEnvelopePlanItem");
requireText("engine", engine, "ResponseContractHardeningItem");
requireText("engine", engine, "providerRuntimeStagingReady: true");
requireText("engine", engine, "providerContractHardeningReady: true");
requireText("engine", engine, "providerBudgetGuardReady: true");
requireText("engine", engine, "providerFallbackPlanReady: true");
requireText("engine", engine, "providerCallAllowed: false");
requireText("engine", engine, "providerCallPerformed: false");
...
requireText("route", route, "/api/ops/ai-provider-runtime-staging-gateway-dry-run");

requireText("ui", ui, "ProviderRuntimeStagingGatewayPanel");
requireText("ui", ui, "Provider Runtime Staging Gateway & Contract Hardening");

requireText("admin", admin, "OperationsAiProviderRuntimeStagingGateway");
requireText("admin", admin, "/api/ops/ai-provider-runtime-staging-gateway-dry-run");

requireText("readme", readme, "AI Provider Runtime Staging Gateway & Contract Hardening");
requireText("package", pkg, "ops:ai-provider-runtime-staging-gateway-check");
requireText("runbook", runbook, "V15.1");
requireText("runbook", runbook, "ops:ai-provider-runtime-staging-gateway-check");
...
const trueFlags = [
  ...
  "providerRuntimeStagingReady",
  "providerContractHardeningReady",
  "providerBudgetGuardReady",
  "providerFallbackPlanReady",
];
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V15_1_PROVIDER_RUNTIME_STAGING_GATEWAY_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-provider-runtime-staging-gateway-check",
  version: "V15.1",
