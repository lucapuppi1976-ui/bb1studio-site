...
const files = {
  engine: "src/lib/ai/aiAgronomicDecisionAssurance.ts",
  route: "src/app/api/ops/ai-agronomic-decision-assurance-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/AgronomicDecisionAssurancePanel.tsx",
  admin: "src/app/admin/operations/OperationsAiAgronomicDecisionAssurance.tsx",
  readme: "AI_AGRONOMIC_DECISION_ASSURANCE_V11_3.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiAgronomicDecisionAssuranceReport");
requireText("engine", engine, "aiAgronomicDecisionAssuranceVersion");
requireText("engine", engine, "AgronomicDecisionAssuranceReport");
requireText("engine", engine, "AssuranceSourceNode");
requireText("engine", engine, "AssuranceGate");
requireText("engine", engine, "HumanSignoffItem");
requireText("engine", engine, "ReviewerDissentItem");
requireText("engine", engine, "decisionAssuranceReady: true");
requireText("engine", engine, "humanSignoffKernelReady: true");
requireText("engine", engine, "dissentRegisterReady: true");
requireText("engine", engine, "safeDecisionPacketReady: true");
...
requireText("route", route, "/api/ops/ai-agronomic-decision-assurance-dry-run");

requireText("ui", ui, "AgronomicDecisionAssurancePanel");
requireText("ui", ui, "Agronomic Decision Assurance & Human Sign-off Kernel");

requireText("admin", admin, "OperationsAiAgronomicDecisionAssurance");
requireText("admin", admin, "/api/ops/ai-agronomic-decision-assurance-dry-run");

requireText("readme", readme, "AI Agronomic Decision Assurance & Human Sign-off Kernel");
requireText("package", pkg, "ops:ai-agronomic-decision-assurance-check");
requireText("runbook", runbook, "V11.3");
requireText("runbook", runbook, "ops:ai-agronomic-decision-assurance-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V11_3_AGRONOMIC_DECISION_ASSURANCE_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-agronomic-decision-assurance-check",
  version: "V11.3",
