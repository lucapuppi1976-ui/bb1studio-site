...
const files = {
  engine: "src/lib/ai/aiPestDiseaseOutbreakSentinel.ts",
  route: "src/app/api/ops/ai-pest-disease-outbreak-sentinel-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/PestDiseaseOutbreakSentinelPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiPestDiseaseOutbreakSentinel.tsx",
  readme: "AI_PEST_DISEASE_OUTBREAK_SENTINEL_V10_6.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiPestDiseaseOutbreakSentinelReport");
requireText("engine", engine, "aiPestDiseaseOutbreakSentinelVersion");
requireText("engine", engine, "PestDiseaseOutbreakSentinelReport");
requireText("engine", engine, "OutbreakRiskZone");
requireText("engine", engine, "PressureSignal");
requireText("engine", engine, "OutbreakScenario");
requireText("engine", engine, "BiosecurityStop");
requireText("engine", engine, "outbreakSentinelReady: true");
requireText("engine", engine, "biosecurityReviewReady: true");
requireText("engine", engine, "pressureForecastSandboxReady: true");
requireText("engine", engine, "surveillancePlanReady: true");
...
requireText("route", route, "/api/ops/ai-pest-disease-outbreak-sentinel-dry-run");

requireText("ui", ui, "PestDiseaseOutbreakSentinelPanel");
requireText("ui", ui, "Pest & Disease Outbreak Sentinel & Biosecurity Simulator");

requireText("admin", admin, "OperationsAiPestDiseaseOutbreakSentinel");
requireText("admin", admin, "/api/ops/ai-pest-disease-outbreak-sentinel-dry-run");

requireText("readme", readme, "AI Pest & Disease Outbreak Sentinel & Biosecurity Simulator");
requireText("package", pkg, "ops:ai-pest-disease-outbreak-sentinel-check");
requireText("runbook", runbook, "V10.6");
requireText("runbook", runbook, "ops:ai-pest-disease-outbreak-sentinel-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V10_6_PEST_DISEASE_OUTBREAK_SENTINEL_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-pest-disease-outbreak-sentinel-check",
  version: "V10.6",
