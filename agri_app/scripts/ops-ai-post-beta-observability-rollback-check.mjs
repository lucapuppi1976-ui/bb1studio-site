...
const files = {
  engine: "src/lib/ai/aiPostBetaObservabilityRollback.ts",
  route: "src/app/api/ops/ai-post-beta-observability-rollback-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/PostBetaObservabilityRollbackPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiPostBetaObservabilityRollback.tsx",
  readme: "AI_POST_BETA_OBSERVABILITY_ROLLBACK_V16_1.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiPostBetaObservabilityRollbackReport");
requireText("engine", engine, "aiPostBetaObservabilityRollbackVersion");
requireText("engine", engine, "PostBetaObservabilityRollbackReport");
requireText("engine", engine, "IncidentSignalItem");
requireText("engine", engine, "RollbackTowerHardeningItem");
requireText("engine", engine, "KillSwitchDrillItem");
requireText("engine", engine, "postBetaObservabilityReady: true");
requireText("engine", engine, "rollbackHardeningReady: true");
requireText("engine", engine, "killSwitchDrillReady: true");
requireText("engine", engine, "incidentReviewReady: true");
...
requireText("route", route, "/api/ops/ai-post-beta-observability-rollback-dry-run");

requireText("ui", ui, "PostBetaObservabilityRollbackPanel");
requireText("ui", ui, "Post-Beta Observability & Rollback Hardening Drill");

requireText("admin", admin, "OperationsAiPostBetaObservabilityRollback");
requireText("admin", admin, "/api/ops/ai-post-beta-observability-rollback-dry-run");

requireText("readme", readme, "AI Post-Beta Observability & Rollback Hardening Drill");
requireText("package", pkg, "ops:ai-post-beta-observability-rollback-check");
requireText("runbook", runbook, "V16.1");
requireText("runbook", runbook, "ops:ai-post-beta-observability-rollback-check");
...
const trueFlags = [
  ...
  "zeroActivationMode",
  "postBetaObservabilityReady",
  "rollbackHardeningReady",
  "killSwitchDrillReady",
  "incidentReviewReady",
];
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V16_1_POST_BETA_OBSERVABILITY_ROLLBACK_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-post-beta-observability-rollback-check",
  version: "V16.1",
