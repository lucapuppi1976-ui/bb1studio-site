...
const files = {
  engine: "src/lib/ai/aiProviderResponseFirewall.ts",
  route: "src/app/api/ops/ai-provider-response-firewall-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/ProviderResponseFirewallPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiProviderResponseFirewall.tsx",
  readme: "AI_PROVIDER_RESPONSE_FIREWALL_V12_2.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiProviderResponseFirewallReport");
requireText("engine", engine, "aiProviderResponseFirewallVersion");
requireText("engine", engine, "ProviderResponseFirewallReport");
requireText("engine", engine, "ProviderResponseSourceNode");
requireText("engine", engine, "ResponseEnvelopeSection");
requireText("engine", engine, "OutputValidationGate");
requireText("engine", engine, "UnsafeOutputRule");
requireText("engine", engine, "providerResponseFirewallReady: true");
requireText("engine", engine, "outputValidationContractReady: true");
requireText("engine", engine, "unsafeOutputRejectionReady: true");
...
requireText("route", route, "/api/ops/ai-provider-response-firewall-dry-run");

requireText("ui", ui, "ProviderResponseFirewallPanel");
requireText("ui", ui, "Provider Response Firewall & Output Validation Contract");

requireText("admin", admin, "OperationsAiProviderResponseFirewall");
requireText("admin", admin, "/api/ops/ai-provider-response-firewall-dry-run");

requireText("readme", readme, "AI Provider Response Firewall & Output Validation Contract");
requireText("package", pkg, "ops:ai-provider-response-firewall-check");
requireText("runbook", runbook, "V12.2");
requireText("runbook", runbook, "ops:ai-provider-response-firewall-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V12_2_PROVIDER_RESPONSE_FIREWALL_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-provider-response-firewall-check",
  version: "V12.2",
