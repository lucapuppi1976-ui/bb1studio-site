...
const files = {
  engine: "src/lib/ai/aiProviderObservabilityDrill.ts",
  route: "src/app/api/ops/ai-provider-observability-drill-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/ProviderObservabilityDrillPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiProviderObservabilityDrill.tsx",
  readme: "AI_PROVIDER_OBSERVABILITY_DRILL_V12_5.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiProviderObservabilityDrillReport");
requireText("engine", engine, "aiProviderObservabilityDrillVersion");
requireText("engine", engine, "ProviderObservabilityDrillReport");
requireText("engine", engine, "ProviderObservabilitySourceNode");
requireText("engine", engine, "RuntimeSignalCard");
requireText("engine", engine, "IncidentDrillCard");
requireText("engine", engine, "QualityDriftWatchItem");
requireText("engine", engine, "providerObservabilityReady: true");
requireText("engine", engine, "incidentDrillCenterReady: true");
requireText("engine", engine, "killSwitchReviewReady: true");
...
requireText("route", route, "/api/ops/ai-provider-observability-drill-dry-run");

requireText("ui", ui, "ProviderObservabilityDrillPanel");
requireText("ui", ui, "Provider Observability & Incident Response Drill Center");

requireText("admin", admin, "OperationsAiProviderObservabilityDrill");
requireText("admin", admin, "/api/ops/ai-provider-observability-drill-dry-run");

requireText("readme", readme, "AI Provider Observability & Incident Response Drill Center");
requireText("package", pkg, "ops:ai-provider-observability-drill-check");
requireText("runbook", runbook, "V12.5");
requireText("runbook", runbook, "ops:ai-provider-observability-drill-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V12_5_PROVIDER_OBSERVABILITY_DRILL_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-provider-observability-drill-check",
  version: "V12.5",
