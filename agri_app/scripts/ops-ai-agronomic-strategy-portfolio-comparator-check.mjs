...
const files = {
  engine: "src/lib/ai/aiAgronomicStrategyPortfolioComparator.ts",
  route: "src/app/api/ops/ai-agronomic-strategy-portfolio-comparator-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/AgronomicStrategyPortfolioComparatorPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiAgronomicStrategyPortfolioComparator.tsx",
  readme: "AI_AGRONOMIC_STRATEGY_PORTFOLIO_COMPARATOR_V14_2.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiAgronomicStrategyPortfolioComparatorReport");
requireText("engine", engine, "aiAgronomicStrategyPortfolioComparatorVersion");
requireText("engine", engine, "AgronomicStrategyPortfolioReport");
requireText("engine", engine, "StrategyPortfolioOption");
requireText("engine", engine, "StrategyTradeoffItem");
requireText("engine", engine, "OptionRankingItem");
requireText("engine", engine, "strategyPortfolioReady: true");
requireText("engine", engine, "tradeoffBoardReady: true");
requireText("engine", engine, "nonExecutionBoundaryReady: true");
requireText("engine", engine, "humanPortfolioSignoffReady: true");
...
requireText("route", route, "/api/ops/ai-agronomic-strategy-portfolio-comparator-dry-run");

requireText("ui", ui, "AgronomicStrategyPortfolioComparatorPanel");
requireText("ui", ui, "Agronomic Strategy Portfolio Comparator & Trade-Off Board");

requireText("admin", admin, "OperationsAiAgronomicStrategyPortfolioComparator");
requireText("admin", admin, "/api/ops/ai-agronomic-strategy-portfolio-comparator-dry-run");

requireText("readme", readme, "AI Agronomic Strategy Portfolio Comparator & Trade-Off Board");
requireText("package", pkg, "ops:ai-agronomic-strategy-portfolio-comparator-check");
requireText("runbook", runbook, "V14.2");
requireText("runbook", runbook, "ops:ai-agronomic-strategy-portfolio-comparator-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V14_2_AGRONOMIC_STRATEGY_PORTFOLIO_COMPARATOR_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-agronomic-strategy-portfolio-comparator-check",
  version: "V14.2",
