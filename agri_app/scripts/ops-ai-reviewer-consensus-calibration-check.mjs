...
const files = {
  engine: "src/lib/ai/aiReviewerConsensusCalibration.ts",
  route: "src/app/api/ops/ai-reviewer-consensus-calibration-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/ReviewerConsensusCalibrationPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiReviewerConsensusCalibration.tsx",
  readme: "AI_REVIEWER_CONSENSUS_CALIBRATION_V13_1.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiReviewerConsensusCalibrationReport");
requireText("engine", engine, "aiReviewerConsensusCalibrationVersion");
requireText("engine", engine, "ReviewerConsensusCalibrationReport");
requireText("engine", engine, "EvidenceWeightingItem");
requireText("engine", engine, "DissentRegisterItem");
requireText("engine", engine, "DisputeResolutionGate");
requireText("engine", engine, "reviewerConsensusReady: true");
requireText("engine", engine, "evidenceWeightingReady: true");
requireText("engine", engine, "disputeResolutionReady: true");
requireText("engine", engine, "humanConsensusSignoffReady: true");
...
requireText("route", route, "/api/ops/ai-reviewer-consensus-calibration-dry-run");

requireText("ui", ui, "ReviewerConsensusCalibrationPanel");
requireText("ui", ui, "Reviewer Consensus Calibration & Dispute Resolution Engine");

requireText("admin", admin, "OperationsAiReviewerConsensusCalibration");
requireText("admin", admin, "/api/ops/ai-reviewer-consensus-calibration-dry-run");

requireText("readme", readme, "AI Reviewer Consensus Calibration & Dispute Resolution Engine");
requireText("package", pkg, "ops:ai-reviewer-consensus-calibration-check");
requireText("runbook", runbook, "V13.1");
requireText("runbook", runbook, "ops:ai-reviewer-consensus-calibration-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V13_1_REVIEWER_CONSENSUS_CALIBRATION_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-reviewer-consensus-calibration-check",
  version: "V13.1",
