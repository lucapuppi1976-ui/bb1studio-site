...
const files = {
  engine: "src/lib/ai/aiCropProtocolBuilder.ts",
  route: "src/app/api/ops/ai-crop-protocol-builder-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/CropProtocolBuilderPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiCropProtocolBuilder.tsx",
  readme: "AI_CROP_PROTOCOL_BUILDER_V10_2.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiCropProtocolBuilderReport");
requireText("engine", engine, "aiCropProtocolBuilderVersion");
requireText("engine", engine, "CropSpecificExpertProtocolReport");
requireText("engine", engine, "CropProtocolVariant");
requireText("engine", engine, "CropProtocolEvidenceGate");
requireText("engine", engine, "CropProtocolConflict");
requireText("engine", engine, "CropProtocolReviewItem");
requireText("engine", engine, "cropProtocolBuilderReady: true");
requireText("engine", engine, "cropSpecificProtocolReady: true");
requireText("engine", engine, "phenologyAwareReviewReady: true");
requireText("engine", engine, "protocolConflictReviewReady: true");
...
requireText("route", route, "/api/ops/ai-crop-protocol-builder-dry-run");

requireText("ui", ui, "CropProtocolBuilderPanel");
requireText("ui", ui, "Crop-Specific Expert Protocol Builder");

requireText("admin", admin, "OperationsAiCropProtocolBuilder");
requireText("admin", admin, "/api/ops/ai-crop-protocol-builder-dry-run");

requireText("readme", readme, "AI Crop-Specific Expert Protocol Builder");
requireText("package", pkg, "ops:ai-crop-protocol-builder-check");
requireText("runbook", runbook, "V10.2");
requireText("runbook", runbook, "ops:ai-crop-protocol-builder-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V10_2_CROP_PROTOCOL_BUILDER_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-crop-protocol-builder-check",
  version: "V10.2",
