...
const files = {
  engine: "src/lib/ai/aiProviderRuntimeCanaryExecution.ts",
  route: "src/app/api/ops/ai-provider-runtime-canary-execution-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/ProviderRuntimeCanaryExecutionPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiProviderRuntimeCanaryExecution.tsx",
  readme: "AI_PROVIDER_RUNTIME_CANARY_EXECUTION_V16_8.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiProviderRuntimeCanaryExecutionReport");
requireText("engine", engine, "aiProviderRuntimeCanaryExecutionVersion");
requireText("engine", engine, "ProviderRuntimeCanaryExecutionReport");
requireText("engine", engine, "CanaryExecutionGateItem");
requireText("engine", engine, "ProviderZeroCallLockItem");
requireText("engine", engine, "ProviderResultBoundaryItem");
requireText("engine", engine, "providerRuntimeCanaryExecutionGateReady: true");
requireText("engine", engine, "providerZeroCallLockReady: true");
requireText("engine", engine, "canaryStopPlanReady: true");
requireText("engine", engine, "canaryNoGoReady: true");
requireText("engine", engine, "providerRuntimeCanaryAllowed: false");
requireText("engine", engine, "providerCanaryCallAllowed: false");
requireText("engine", engine, "canaryExecutionAllowed: false");
...
requireText("route", route, "/api/ops/ai-provider-runtime-canary-execution-dry-run");

requireText("ui", ui, "ProviderRuntimeCanaryExecutionPanel");
requireText("ui", ui, "Provider Runtime Canary Execution Gate & Zero-Call Execution Lock");

requireText("admin", admin, "OperationsAiProviderRuntimeCanaryExecution");
requireText("admin", admin, "/api/ops/ai-provider-runtime-canary-execution-dry-run");

requireText("readme", readme, "AI Provider Runtime Canary Execution Gate & Zero-Call Execution Lock");
requireText("package", pkg, "ops:ai-provider-runtime-canary-execution-check");
requireText("runbook", runbook, "V16.8");
requireText("runbook", runbook, "ops:ai-provider-runtime-canary-execution-check");
...
const trueFlags = [
  ...
  "zeroActivationMode",
  "providerRuntimeCanaryExecutionGateReady",
  "providerZeroCallLockReady",
  "canaryStopPlanReady",
  "canaryNoGoReady",
];
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V16_8_PROVIDER_RUNTIME_CANARY_EXECUTION_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-provider-runtime-canary-execution-check",
  version: "V16.8",
