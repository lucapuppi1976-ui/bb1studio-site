...
const files = {
  engine: "src/lib/ai/aiReviewerRationaleLedger.ts",
  route: "src/app/api/ops/ai-reviewer-rationale-ledger-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/ReviewerRationaleLedgerPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiReviewerRationaleLedger.tsx",
  readme: "AI_REVIEWER_RATIONALE_LEDGER_V13_3.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiReviewerRationaleLedgerReport");
requireText("engine", engine, "aiReviewerRationaleLedgerVersion");
requireText("engine", engine, "ReviewerRationaleLedgerReport");
requireText("engine", engine, "EvidenceDecisionTraceItem");
requireText("engine", engine, "ReviewerRationaleItem");
requireText("engine", engine, "DecisionHoldReasonItem");
requireText("engine", engine, "reviewerRationaleReady: true");
requireText("engine", engine, "evidenceDecisionTraceReady: true");
requireText("engine", engine, "rationaleAuditReplayReady: true");
requireText("engine", engine, "humanRationaleSignoffReady: true");
...
requireText("route", route, "/api/ops/ai-reviewer-rationale-ledger-dry-run");

requireText("ui", ui, "ReviewerRationaleLedgerPanel");
requireText("ui", ui, "Reviewer Rationale Ledger & Evidence-to-Decision Traceability Matrix");

requireText("admin", admin, "OperationsAiReviewerRationaleLedger");
requireText("admin", admin, "/api/ops/ai-reviewer-rationale-ledger-dry-run");

requireText("readme", readme, "AI Reviewer Rationale Ledger & Evidence-to-Decision Traceability Matrix");
requireText("package", pkg, "ops:ai-reviewer-rationale-ledger-check");
requireText("runbook", runbook, "V13.3");
requireText("runbook", runbook, "ops:ai-reviewer-rationale-ledger-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V13_3_REVIEWER_RATIONALE_LEDGER_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-reviewer-rationale-ledger-check",
  version: "V13.3",
