...
const files = {
  engine: "src/lib/ai/aiAgronomicDecisionSimulationBoard.ts",
  route: "src/app/api/ops/ai-agronomic-decision-simulation-board-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/AgronomicDecisionSimulationBoardPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiAgronomicDecisionSimulationBoard.tsx",
  readme: "AI_AGRONOMIC_DECISION_SIMULATION_BOARD_V14_0.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiAgronomicDecisionSimulationBoardReport");
requireText("engine", engine, "aiAgronomicDecisionSimulationBoardVersion");
requireText("engine", engine, "AgronomicDecisionSimulationReport");
requireText("engine", engine, "DecisionSimulationScenario");
requireText("engine", engine, "AgronomicOptionScenario");
requireText("engine", engine, "NonExecutionCertificateItem");
requireText("engine", engine, "decisionSimulationReady: true");
requireText("engine", engine, "strategyPackReady: true");
requireText("engine", engine, "nonExecutionCertificateReady: true");
requireText("engine", engine, "humanStrategySignoffReady: true");
...
requireText("route", route, "/api/ops/ai-agronomic-decision-simulation-board-dry-run");

requireText("ui", ui, "AgronomicDecisionSimulationBoardPanel");
requireText("ui", ui, "Agronomic Decision Simulation Board & Non-Execution Strategy Pack");

requireText("admin", admin, "OperationsAiAgronomicDecisionSimulationBoard");
requireText("admin", admin, "/api/ops/ai-agronomic-decision-simulation-board-dry-run");

requireText("readme", readme, "AI Agronomic Decision Simulation Board & Non-Execution Strategy Pack");
requireText("package", pkg, "ops:ai-agronomic-decision-simulation-board-check");
requireText("runbook", runbook, "V14.0");
requireText("runbook", runbook, "ops:ai-agronomic-decision-simulation-board-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V14_0_AGRONOMIC_DECISION_SIMULATION_BOARD_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-agronomic-decision-simulation-board-check",
  version: "V14.0",
