...
const files = {
  engine: "src/lib/ai/aiStagedProviderRuntimeBeta.ts",
  route: "src/app/api/ops/ai-staged-provider-runtime-beta-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/StagedProviderRuntimeBetaPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiStagedProviderRuntimeBeta.tsx",
  readme: "AI_STAGED_PROVIDER_RUNTIME_BETA_V16_4.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiStagedProviderRuntimeBetaReport");
requireText("engine", engine, "aiStagedProviderRuntimeBetaVersion");
requireText("engine", engine, "StagedProviderRuntimeBetaReport");
requireText("engine", engine, "RuntimeAllowlistItem");
requireText("engine", engine, "ProviderContractItem");
requireText("engine", engine, "RuntimeBetaGoNoGoItem");
requireText("engine", engine, "stagedProviderRuntimeBetaReady: true");
requireText("engine", engine, "explicitActivationApprovalReady: true");
requireText("engine", engine, "runtimeBetaDryRunReady: true");
requireText("engine", engine, "productionRuntimeLockReady: true");
requireText("engine", engine, "providerRuntimeBetaAllowed: false");
requireText("engine", engine, "providerRuntimeBetaPerformed: false");
requireText("engine", engine, "providerCalled: false");
...
requireText("route", route, "/api/ops/ai-staged-provider-runtime-beta-dry-run");

requireText("ui", ui, "StagedProviderRuntimeBetaPanel");
requireText("ui", ui, "Staged Provider Runtime Beta Gate & Explicit Activation Approval Lock");

requireText("admin", admin, "OperationsAiStagedProviderRuntimeBeta");
requireText("admin", admin, "/api/ops/ai-staged-provider-runtime-beta-dry-run");

requireText("readme", readme, "AI Staged Provider Runtime Beta Gate & Explicit Activation Approval Lock");
requireText("package", pkg, "ops:ai-staged-provider-runtime-beta-check");
requireText("runbook", runbook, "V16.4");
requireText("runbook", runbook, "ops:ai-staged-provider-runtime-beta-check");
...
const trueFlags = [
  ...
  "zeroActivationMode",
  "stagedProviderRuntimeBetaReady",
  "explicitActivationApprovalReady",
  "runtimeBetaDryRunReady",
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V16_4_STAGED_PROVIDER_RUNTIME_BETA_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-staged-provider-runtime-beta-check",
  version: "V16.4",
