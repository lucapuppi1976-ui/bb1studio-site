...
const files = {
  engine: "src/lib/ai/aiOnlineOperationalReadiness.ts",
  route: "src/app/api/ops/ai-online-operational-readiness-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/OnlineOperationalReadinessPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiOnlineOperationalReadiness.tsx",
  readme: "AI_ONLINE_OPERATIONAL_READINESS_V15_0.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiOnlineOperationalReadinessReport");
requireText("engine", engine, "aiOnlineOperationalReadinessVersion");
requireText("engine", engine, "OnlineOperationalReadinessReport");
requireText("engine", engine, "ProviderActivationPlanItem");
requireText("engine", engine, "DataMigrationPlanItem");
requireText("engine", engine, "BetaGoNoGoItem");
requireText("engine", engine, "onlineControlledReady: true");
requireText("engine", engine, "operationalAiReady: false");
...
requireText("engine", engine, "automationActivationAllowed: false");
...
requireText("route", route, "/api/ops/ai-online-operational-readiness-dry-run");

requireText("ui", ui, "OnlineOperationalReadinessPanel");
requireText("ui", ui, "Online Operational Readiness & Provider Activation Plan");

requireText("admin", admin, "OperationsAiOnlineOperationalReadiness");
requireText("admin", admin, "/api/ops/ai-online-operational-readiness-dry-run");

requireText("readme", readme, "Online Operational Readiness & Provider Activation Plan");
requireText("package", pkg, "ops:ai-online-operational-readiness-check");
requireText("runbook", runbook, "V15.0");
requireText("runbook", runbook, "ops:ai-online-operational-readiness-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V15_0_ONLINE_OPERATIONAL_READINESS_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-online-operational-readiness-check",
  version: "V15.0",
