...
const files = {
  engine: "src/lib/ai/aiRuntimeIncidentResponseBoard.ts",
  route: "src/app/api/ops/ai-runtime-incident-response-board-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/RuntimeIncidentResponseBoardPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiRuntimeIncidentResponseBoard.tsx",
  readme: "AI_RUNTIME_INCIDENT_RESPONSE_BOARD_V16_5.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiRuntimeIncidentResponseBoardReport");
requireText("engine", engine, "aiRuntimeIncidentResponseBoardVersion");
requireText("engine", engine, "RuntimeIncidentResponseBoardReport");
requireText("engine", engine, "IncidentIntakeItem");
requireText("engine", engine, "ProviderFailureDrillItem");
requireText("engine", engine, "RollbackActionCardItem");
requireText("engine", engine, "runtimeIncidentResponseReady: true");
requireText("engine", engine, "providerFailureDrillReady: true");
requireText("engine", engine, "incidentNoGoReady: true");
requireText("engine", engine, "rollbackActionCardsReady: true");
requireText("engine", engine, "incidentResponseAllowed: false");
requireText("engine", engine, "providerFailureDrillAllowed: false");
requireText("engine", engine, "runtimeIncidentWriteAllowed: false");
...
requireText("route", route, "/api/ops/ai-runtime-incident-response-board-dry-run");

requireText("ui", ui, "RuntimeIncidentResponseBoardPanel");
requireText("ui", ui, "Runtime Incident Response Board & Provider Failure Drill");

requireText("admin", admin, "OperationsAiRuntimeIncidentResponseBoard");
requireText("admin", admin, "/api/ops/ai-runtime-incident-response-board-dry-run");

requireText("readme", readme, "AI Runtime Incident Response Board & Provider Failure Drill");
requireText("package", pkg, "ops:ai-runtime-incident-response-board-check");
requireText("runbook", runbook, "V16.5");
requireText("runbook", runbook, "ops:ai-runtime-incident-response-board-check");
...
const falseFlags = [
  ...
  "incidentResponseAllowed",
  "incidentResponsePerformed",
  "providerFailureDrillAllowed",
  "providerFailureDrillPerformed",
  "runtimeIncidentWriteAllowed",
  "runtimeIncidentWritePerformed",
...
const trueFlags = [
  ...
  "zeroActivationMode",
  "runtimeIncidentResponseReady",
  "providerFailureDrillReady",
  "incidentNoGoReady",
  "rollbackActionCardsReady",
];
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V16_5_RUNTIME_INCIDENT_RESPONSE_BOARD_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-runtime-incident-response-board-check",
  version: "V16.5",
