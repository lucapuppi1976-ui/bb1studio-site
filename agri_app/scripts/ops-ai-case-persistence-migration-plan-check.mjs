...
const files = {
  engine: "src/lib/ai/aiCasePersistenceMigrationPlan.ts",
  route: "src/app/api/ops/ai-case-persistence-migration-plan-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/CasePersistenceMigrationPlanPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiCasePersistenceMigrationPlan.tsx",
  readme: "AI_CASE_PERSISTENCE_MIGRATION_PLAN_V15_2.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiCasePersistenceMigrationPlanReport");
requireText("engine", engine, "aiCasePersistenceMigrationPlanVersion");
requireText("engine", engine, "CasePersistenceMigrationReport");
requireText("engine", engine, "EntityBlueprintItem");
requireText("engine", engine, "MigrationPlanItem");
requireText("engine", engine, "BackupRestorePlanItem");
requireText("engine", engine, "casePersistencePlanReady: true");
requireText("engine", engine, "storageSafetyBlueprintReady: true");
requireText("engine", engine, "migrationRehearsalPlanReady: true");
requireText("engine", engine, "backupRestorePlanReady: true");
requireText("engine", engine, "casePersistenceActivationAllowed: false");
...
requireText("route", route, "/api/ops/ai-case-persistence-migration-plan-dry-run");

requireText("ui", ui, "CasePersistenceMigrationPlanPanel");
requireText("ui", ui, "Case Persistence Migration Plan & Storage Safety Blueprint");

requireText("admin", admin, "OperationsAiCasePersistenceMigrationPlan");
requireText("admin", admin, "/api/ops/ai-case-persistence-migration-plan-dry-run");

requireText("readme", readme, "AI Case Persistence Migration Plan & Storage Safety Blueprint");
requireText("package", pkg, "ops:ai-case-persistence-migration-plan-check");
requireText("runbook", runbook, "V15.2");
requireText("runbook", runbook, "ops:ai-case-persistence-migration-plan-check");
...
const trueFlags = [
  ...
  "casePersistencePlanReady",
  "storageSafetyBlueprintReady",
  "migrationRehearsalPlanReady",
  "backupRestorePlanReady",
];
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V15_2_CASE_PERSISTENCE_MIGRATION_PLAN_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-case-persistence-migration-plan-check",
  version: "V15.2",
