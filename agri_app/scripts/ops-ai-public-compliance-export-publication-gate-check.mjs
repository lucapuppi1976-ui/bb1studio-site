...
const files = {
  engine: "src/lib/ai/aiPublicComplianceExportPublicationGate.ts",
  route: "src/app/api/ops/ai-public-compliance-export-publication-gate-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/PublicComplianceExportPublicationGatePanel.tsx",
  admin: "src/app/admin/operations/OperationsAiPublicComplianceExportPublicationGate.tsx",
  readme: "AI_PUBLIC_COMPLIANCE_EXPORT_PUBLICATION_GATE_V17_0.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiPublicComplianceExportPublicationGateReport");
requireText("engine", engine, "aiPublicComplianceExportPublicationGateVersion");
requireText("engine", engine, "PublicComplianceExportPublicationReport");
requireText("engine", engine, "PublicationGateItem");
requireText("engine", engine, "LegalFinalApprovalItem");
requireText("engine", engine, "PrivacyFinalApprovalItem");
requireText("engine", engine, "publicComplianceExportPublicationGateReady: true");
requireText("engine", engine, "legalPrivacyApprovalLockReady: true");
requireText("engine", engine, "publicationNoGoReady: true");
requireText("engine", engine, "takedownRollbackPlanReady: true");
requireText("engine", engine, "publicComplianceExportPublicationAllowed: false");
requireText("engine", engine, "publicationPackageWriteAllowed: false");
requireText("engine", engine, "publicShareAllowed: false");
...
requireText("route", route, "/api/ops/ai-public-compliance-export-publication-gate-dry-run");

requireText("ui", ui, "PublicComplianceExportPublicationGatePanel");
requireText("ui", ui, "Public Compliance Export Publication Gate & Legal Privacy Final Approval Lock");

requireText("admin", admin, "OperationsAiPublicComplianceExportPublicationGate");
requireText("admin", admin, "/api/ops/ai-public-compliance-export-publication-gate-dry-run");

requireText("readme", readme, "AI Public Compliance Export Publication Gate & Legal Privacy Final Approval Lock");
requireText("package", pkg, "ops:ai-public-compliance-export-publication-gate-check");
requireText("runbook", runbook, "V17.0");
requireText("runbook", runbook, "ops:ai-public-compliance-export-publication-gate-check");
...
const falseFlags = [
  ...
  "publicationTakedownAllowed",
  "publicationTakedownPerformed",
];
...
const trueFlags = [
  ...
  "zeroActivationMode",
  "publicComplianceExportPublicationGateReady",
  "legalPrivacyApprovalLockReady",
  "publicationNoGoReady",
  "takedownRollbackPlanReady",
];
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V17_0_PUBLIC_COMPLIANCE_EXPORT_PUBLICATION_GATE_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-public-compliance-export-publication-gate-check",
  version: "V17.0",
