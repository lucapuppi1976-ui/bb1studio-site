...
const files = {
  engine: "src/lib/ai/aiAgronomicExecutiveDossier.ts",
  route: "src/app/api/ops/ai-agronomic-executive-dossier-dry-run/route.ts",
  ui: "src/app/ai/photo-diagnosis/AgronomicExecutiveDossierPanel.tsx",
  admin: "src/app/admin/operations/OperationsAiAgronomicExecutiveDossier.tsx",
  readme: "AI_AGRONOMIC_EXECUTIVE_DOSSIER_V14_5.md",
  pkg: "package.json",
...
requireText("engine", engine, "buildAiAgronomicExecutiveDossierReport");
requireText("engine", engine, "aiAgronomicExecutiveDossierVersion");
requireText("engine", engine, "AgronomicExecutiveDossierReport");
requireText("engine", engine, "ExecutiveDossierItem");
requireText("engine", engine, "StrategyNarrativeFreezeItem");
requireText("engine", engine, "NonOperationalCertificateItem");
requireText("engine", engine, "executiveDossierReady: true");
requireText("engine", engine, "strategyNarrativeFreezeReady: true");
requireText("engine", engine, "nonOperationalCertificateReady: true");
requireText("engine", engine, "humanExecutiveSignoffReady: true");
...
requireText("route", route, "/api/ops/ai-agronomic-executive-dossier-dry-run");

requireText("ui", ui, "AgronomicExecutiveDossierPanel");
requireText("ui", ui, "Agronomic Executive Board Dossier & Non-Operational Strategy Narrative");

requireText("admin", admin, "OperationsAiAgronomicExecutiveDossier");
requireText("admin", admin, "/api/ops/ai-agronomic-executive-dossier-dry-run");

requireText("readme", readme, "AI Agronomic Executive Board Dossier & Non-Operational Strategy Narrative");
requireText("package", pkg, "ops:ai-agronomic-executive-dossier-check");
requireText("runbook", runbook, "V14.5");
requireText("runbook", runbook, "ops:ai-agronomic-executive-dossier-check");
...
for (const supportScript of [
  ...
  requireText(supportScript, content, "AGRI_V14_5_AGRONOMIC_EXECUTIVE_DOSSIER_CHECK");
}

const summary = {
  ok: failures.length === 0,
  check: "ops-ai-agronomic-executive-dossier-check",
  version: "V14.5",
